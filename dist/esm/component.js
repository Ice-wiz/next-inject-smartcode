...
export var VWOScript = function VWOScript(_ref) {
  ...
  if (!isAppDir) {
    ...
    }), /*#__PURE__*/React.createElement(_Script, _extends({
      id: "vwoCode",
      strategy: "beforeInteractive",
